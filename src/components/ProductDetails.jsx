...
const ProductPage = () => {
  ...
  return (
    <div className="w-full mx-auto mt-10 flex flex-col items-center lg:flex-row gap-10 p-5">
      {/* product image */}
      <motion.div
        className="w-full lg:w-[60%] h-[350px] border border-gray-300"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        {isClothing ? (
          <>
            {/* Size Selection */}
            <div className="mt-5">
              <label htmlFor="size" className="block text-lg">Choose Size:</label>
              <select
                id="size"
                value={selectedSize}
            ...
            {/* Color Selection */}
            <div className="mt-5">
              <label htmlFor="color" className="block text-lg">Choose Color:</label>
              <select
                id="color"
                value={selectedColor}
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Get your product delivered within 2-5 business days</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Shop with confidence. Secure payment methods</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-semibold text-lg">Stylish & Guaranteed Quality</p>
              <p className="text-sm text-gray-600">We ensure top-quality products delivered to you</p>
            </div>
          </div>
        </motion.div>
